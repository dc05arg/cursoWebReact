...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2021 a las 19:00:23
...
(4, 'María', 'Anchor', 'Desarrollador Web', 26, 85000, 'mary@bignet.com'),
...
(14, 'Daniel', 'Gutiérrez', 'Administrador de sistemas', 34, 90000, 'daniel@bignet.com'),
(15, 'Miguel', 'Harper', 'Ejecutivo de Ventas Senior', 36, 120000, 'miguel@bignet.com'),
(16, 'Mónica', 'Sanchez', 'Ejecutivo de Ventas', 30, 90000, 'monica@bignet.com'),
(17, 'Alicia', 'Simlai', 'Ejecutivo de Ventas', 27, 70000, 'alicia@bignet.com'),
(18, 'José', 'Iriarte', 'Ejecutivo de Ventas', 27, 72000, 'jose@bignet.com'),
(19, 'Sabrina', 'Allende', 'Gerente de Soporte técnico', 32, 200000, 'sabrina@bignet.com'),
(20, 'Pedro', 'Campeón', 'Gerente de finanzas', 36, 220000, 'pedro@bignet.com'),
...
--
ALTER TABLE `empleados`
  MODIFY `id_emp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
